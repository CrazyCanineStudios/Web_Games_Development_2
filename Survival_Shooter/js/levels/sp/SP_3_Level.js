...
// Locks pointer on mousedown
    ...
    this.enemies.create(this.enemy1 = new Enemy(this, 288, 600, true));
    ...
    this.enemies.create(this.enemy5 = new Enemy(this, 258, 172, false));
    ...
    this.enemies.create(this.enemy10 = new Enemy(this, 868, 464, false));
    ...
    this.enemies.create(this.enemy15 = new Enemy(this, 1522, 570, false));
    this.enemies.create(this.enemy16 = new Enemy(this, 1522, 720, false));
