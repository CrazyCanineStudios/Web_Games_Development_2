var config = {
    ...
    },gamePaused = false, reticle, player1Char = "Tom",player2Char = "Harry",pauseMusic,mpIntro, player, player2, lives = 3, moving, time, music,confirmSound, barrier, quickStart = true, game = new Phaser.Game(config);
